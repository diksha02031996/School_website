...
<!--<div class="wrapper col2"> 
  <div id="featured_slide">
   ...
   <img src="jn1.jpg" width="1359" height="280" />
   <!-- <div id="quos">Neque porro quisquam est qui , consectetur, adipisci velit..."</div>-->
    <div id="footWrap">
  <div id="footPanel">
    <div id="footNav">
      <ul>
...
<div id="contentWrap">
  ...
  <form id="form1" runat="server">
      ...
      <div class="toplinks">
        ...
        <h2>Latest news</h2>
          ...
          <br />
             ...
             <asp:LinkButton ID="lnknews1" runat="server" onclick="lnknews1_Click" 
                  Font-Size="Large" ForeColor="Blue" Height="33px" Width="85px">LinkButton</asp:LinkButton>
          ...
          <br />
              ...
              <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="Large" 
                  ForeColor="Blue" Height="43px">LinkButton</asp:LinkButton>
           
              <br />
          <br />
           
              <asp:LinkButton ID="LinkButton2" runat="server" Font-Size="Large" 
                  ForeColor="Blue" Height="38px">LinkButton</asp:LinkButton>
           
                <br />
          <br />
           
                <asp:LinkButton ID="LinkButton3" runat="server" Font-Size="Large" 
                    ForeColor="Blue" Height="36px">LinkButton</asp:LinkButton>
    ...
    <div id="middlePanel">
        <div class="top">
            <h2>About Us       <h3 class="style2">The Training & Placement Cell has been established to impart training and to promote placement of students in various industries and organizations.
...
&nbsp;<br />
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <asp:Button ID="btnadminlogin" runat="server" onclick="btnadminlogin_Click" 
         Text="Login" />
     <br />
     <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
